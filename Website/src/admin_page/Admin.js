...
export default function ShoppingCart() {
  ...
  const [productToCategoryVisible, setProductToCategoryVisible] =
    useState(false);
  const [productToVariationVisible, setProductToVariationVisible] =
    useState(false);
  ...
  async function handleChange(event, selected) {
    ...
    switch (selected) {
      ...
      case "updateCatPrior":
        ...
        break;
      case "ordnum":
        console.log("event ordestate: " + event.target.value);
        {
          /*12*/
        }
        await setOrderState(event.target.value);
        await console.log("orderstate: " + orderState);
        {
          /*-1*/
        }
        break;
    ...
    console.log("mindenekutan: " + orderState);
    {
      /*12*/
    }
  ...
  if (
    user.roles.includes("ROLE_ADMIN1") ||
    user.roles.includes("ROLE_ADMIN2")
  ) 
  {
    if (loading) {
      return <div className="text-center">Egy kis türelmet...</div>;
    } else {
      return (
        <div class="container-admin">
          <h1 className="text-center admin_tx">Admin panel</h1>
          <div class="row gombtomb">
            <div class="col gombkulso">
              {" "}
              <button
                onClick={() => getAllOrder()}
                type="button"
                className="btn btn-primary admingomb"
              >
            ...
            <div class="col gombkulso">
              ...
              <button
                ...
                className="btn btn-primary admingomb"
              >
                Termék felvétele/törlése a kiválasztott kategóriához/ból
              </button>
            </div>
            <div class="vl"></div>
            <div class="col gombkulso">
              {" "}
              <button
                onClick={() => addProductToVariation()}
                type="button"
                className="btn btn-primary admingomb"
              >
                Termék felvétele/törlése a kiválasztott variációhoz/ból
              </button>
            </div>
          </div>
              ...
              <div>
                  ...
                  <div>
                    ...
                    {JSON.parse(availableUsers).map((user) => (
                      <>
                        ...
                        <br></br>
                        <button
                          onClick={() => updateUserRights(user.userId)}
                          className="btn btn-success"
                        >
                          Felhasználó jogainak módosítása
                        </button>
                      </>
                    ))}
                  </div>
                ...
                {UpdateUserRightsVisible && (
                  <>
                    ...
                    <input
                      onChange={(e) => handleChange(e, "userRights")}
                      id="userRights"
                      type="text"
                      required
                    ></input>
                    <button
                      ...
                      onClick={() => confirmUpdateUserRights()}
                    >
                      Felhasználó jogainak frissítése
                    </button>
                  </>
                )}
                ...
                {productVisible && (
                  <div>
                    ...
                    <label class="admin_cimke" for="prodName">
                      Termék neve:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                    ...
                    ></input>
                    <br></br>
                    <label class="admin_cimke" for="prodDesc">
                      Termék leírása:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "prodDesc")}
                      id="prodDesc"
                      type="text"
                      required
                    ></input>
                    <br></br>
                    <label class="admin_cimke" for="prodCategory">
                      Termék kategória (lehet több is):{" "}
                    </label>
                    <br></br>
                        ...
                        <label class="options">
                          <input
                            onChange={(e) => {
                              // add to list
                              if (e.target.checked) {
                                setCatInfo([...catInfo, catInfo.push(cat.id)]);
                              } else {
                                // remove from list
                                setCatInfo(
                    ...
                    {/* 
                                                ...
                                                */}
                    <br></br>
                    <label class="admin_cimke" for="prodVariation">
                      Termék variációja (lehet több is):{" "}
                    </label>
                    <br></br>
                    ...
                    <br></br>
                    <label class="admin_cimke" for="prodPrice">
                      Termék ára:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                    ...
                    ></input>
                    <br></br>
                    <label class="admin_cimke" for="prodSalePrice">
                      Termék eladási ára:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "prodSalePrice")}
                      id="prodSalePrice"
                      type="number"
                      required
                    ></input>
                    <label class="admin_cimke" for="prodStock">
                      Termék Készlet:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "prodStock")}
                      id="prodStock"
                      type="number"
                      required
                    ></input>
                    <br></br>
                    <label class="admin_cimke" for="prodImage">
                      Képek 1/sör formátum URL "szóköz" prioritás
                    </label>
                    <textarea
                      id="story"
                      placeholder="Példa: https://pbs.twimg.com/media/Fkcc_lzX0CYsnGf.jpg 1"
                      class="admin_bevitel"
                      name="story"
                      rows="5"
                      cols="33"
                      onChange={(e) => handleChange(e, "prodImage")}
                    ></textarea>
                    <br></br>
                    {/*<input class="admin_bevitel" onChange={(e) => handleChange(e,"prodImage")} id="prodImage" type="textarea" required></input><br></br>*/}
                    <label class="admin_cimke" for="prodVisible">
                      Termék láthatósága:
                    </label>
                    <select
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "prodVisible")}
                    >
                      <option id="prodVisible" value="true">
                        Igaz
                      </option>
                      <option id="prodVisible" value="false">
                        Hamis
                      </option>
                    </select>
                    <br></br>
                ...
                {updateProductVisible && (
                  <div>
                    ...
                    <textarea
                      ...
                      onChange={(e) => handleChange(e, "prodImage")}
                    ></textarea>
                    <label class="admin_cimke" for="prodVisible2">
                      Termék láthatósága:
                    </label>
                    <select
                      id="prodVisible2"
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "prodVisible2")}
                    >
                      <option id="prodVisible2" value="true">
                        Igaz
                      </option>
                      <option id="prodVisible2" value="false">
                        Hamis
                      </option>
                    </select>
                    <br></br>
                ...
                {updateVariationVisible && (
                  <>
                    ...
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "updateVarName")}
                      type="text"
                      required
                    ></input>
                    <button
                      ...
                      onClick={() => updateVariationConfirm(varId, varName)}
                    >
                      Módosít
                    </button>
                  </>
                ...
                {updateCategoryVisible && (
                  <>
                    ...
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "updateCatName")}
                      id="updCatName"
                      type="text"
                      required
                    ></input>
                    ...
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "updateCatDesc")}
                      id="updCatDesc"
                      type="text"
                      required
                    ></input>
                    ...
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "updateCatPrior")}
                      id="updCatPrior"
                      type="text"
                      required
                    ></input>
                    <button
                      ...
                      className="btn btn-info"
                      onClick={() =>
                        updateCategoryConfirm(catId, catName, catDesc, catPrior)
                      }
                    >
                      Módosít
                    </button>
                ...
                {categories && (
                  <div>
                    ...
                    <label class="admin_cimke" for="catName">
                      Kategória neve:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      ...
                      required
                    ></input>
                    <label class="admin_cimke" for="catDesc">
                      Kategória leírása:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      ...
                      required
                    ></input>
                    <label class="admin_cimke" for="catPrior">
                      Kategória prioritása:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                      onChange={(e) => handleChange(e, "catPrior")}
                      id="prodDesc"
                      type="number"
                      required
                    ></input>
                    <button
                      onClick={() =>
                        handleCatSubmit(catName, catDesc, catPrior)
                      }
                      className="btn btn-primary"
                      type="button"
                    >
                ...
                {variations && (
                  <div>
                    ...
                    <label class="admin_cimke" for="varName">
                      Variáció neve:{" "}
                    </label>
                    <input
                      class="admin_bevitel"
                    ...
                    <button
                      onClick={() => handleVarSubmit(varName)}
                      className="btn btn-primary"
                      type="button"
                    >
                      Új variáció felvétele
                    </button>
                  </div>
                )}
